...
void testIsConflictFree() {
    ...
    std::set<std::string> conflictFreeExtension = {"a", "d"};
...
void testIsAdmissible() {
    ...
    std::set<std::string> admissibleExtension = {"a"};    // Devrait être admissible
...
void testIsComplete() {
    ...
    std::set<std::string> completeExtension = {"a", "c", "d"};  
    std::set<std::string> incompleteExtension = {"a", "c"};     
